...
ThinkPHP 目前使用 Git 来控制程序版本，如果你想为 ThinkPHP 贡献源代码，请先大致了解 Git 的使用方法。我们目前把项目托管在 GitHub 上，任何 GitHub 客户都可以向我们贡献代码。
...
*Windows 客户推荐添加 PHP bin 目录到 PATH，方便使用 composer*

*Linux 客户自行配置环境， Mac 客户推荐使用内置 Apache 配合 Homebrew 安装 PHP 和 MariaDB*
